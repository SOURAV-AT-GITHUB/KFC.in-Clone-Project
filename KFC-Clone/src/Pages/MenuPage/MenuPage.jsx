...
const MenuPage = () => {
  ...
  document.title='KFC Menu Prices | KFC Menu Deals, Offers & Exclusives'
  const data = menuData;
  var categories = [];
  data.map((e) =>
  ...
  return (
    ...
    >
      <Box
        ...
        top={
          isSmallDevice? "185": param.category ? "100": "0"
        }
        left="0"
        ...
        >
          {categories.map((category) => (
            <Button
              ...
              color={
                param.category ===category.toLowerCase().replace(/\s+/g, "-") ? "black" : "gray"
              }
              textAlign="left"
